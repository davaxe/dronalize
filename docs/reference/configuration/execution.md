...
Execution settings control how work is distributed while processing. In most cases, this section is only about how many workers to use and whether work should be batched.
</div>
