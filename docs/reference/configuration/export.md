...
Export settings control what is persisted after preprocessing. In practice, this means choosing the trajectory schema, numeric precision, and any backend-specific output options.
</div>
