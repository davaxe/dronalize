...
Dronalize does not currently rely on a dataset-specific version marker for HOTEL. The raw layout used by the loader does not expose a stable release version.
