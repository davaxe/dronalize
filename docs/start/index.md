...
This section covers the shortest path from installation to a working preprocessing run, then
points to the practical pages you are likely to need next.
</div>
...
1. Install the base package and any extras you need.
2. Run the CLI walkthrough once to confirm the environment works.
3. Switch to the Python entry points if you want to embed preprocessing in code.
