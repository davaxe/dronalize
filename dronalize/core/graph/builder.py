...
class GraphBuilder(ABC):
    ...
    def build_impl(
        ...
        by `GraphBuilder` (`add_node`, `add_edge`, `add_path`,
        `add_path_lazy`, etc.).
    ...
    # ------------------------------------------------------------------
    # Coordinate lookup helpers (useful for subclasses)
    # ------------------------------------------------------------------
...
# ======================================================================
# Interpolation utilities (unchanged from the original module)
# ======================================================================
