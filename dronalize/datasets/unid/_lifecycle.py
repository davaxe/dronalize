...
from dronalize.datasets.unid.graph_builder import UniDGraphBuilder as _GraphBuilder
...
@contextmanager
def unid_lifecycle_context(
    root: Path, loader_config: LoaderConfig, map_config: MapConfig
) -> Generator[None, None, None]:
    """Lifecycle context for the uniD dataset.
    ...
    for map_path in map_dir.rglob("*.osm"):
        ...
        builder = _GraphBuilder(map_path)
