...
from dronalize.datasets.vod.graph_builder import VODMapGraphBuilder as _GraphBuilder
...
def vod_lifecycle_context(
    ...
    builder = _GraphBuilder.from_json_file(map_dir)
