...
class A43GraphBuilder(GraphBuilder[int, IntIDNode]):
    ...
    from the trajectories of the vehicles. The graph builder uses a mathematical heuristic to infer
    the lane structure based on lane width and the number of lanes.
    """
