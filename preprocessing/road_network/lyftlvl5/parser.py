...
import preprocessing.road_network.lyftlvl5.proto.road_network_pb2 as proto
from preprocessing.road_network.common import BaseEnum, IntIDNode
...
class LaneBoundary:
    ...
    def from_proto_lane_boundary(
        ...
        return cls(
            ...
            type_change_distances=type_change_distances
            if type_change_distances
            else None,
        )
