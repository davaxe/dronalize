...
class CameraCalibration(_message.Message):
    __slots__ = ["extrinsic", "height", "intrinsic", "name", "rolling_shutter_direction", "width"]
...
class CameraImage(_message.Message):
    __slots__ = ["camera_readout_done_time", "camera_segmentation_label", "camera_trigger_time", "image", "name", "pose", "pose_timestamp", "shutter", "velocity"]
...
class CameraName(_message.Message):
    ...
    REAR: CameraName.Name
    REAR_LEFT: CameraName.Name
    REAR_RIGHT: CameraName.Name
...
class CameraSegmentationLabel(_message.Message):
    __slots__ = ["instance_id_to_global_id_mapping", "num_cameras_covered", "panoptic_label", "panoptic_label_divisor", "sequence_id"]
    class InstanceIDToGlobalIDMapping(_message.Message):
        __slots__ = ["global_instance_id", "is_tracked", "local_instance_id"]
...
class Context(_message.Message):
    __slots__ = ["camera_calibrations", "laser_calibrations", "name", "stats"]
    class Stats(_message.Message):
        __slots__ = ["camera_object_counts", "laser_object_counts", "location", "time_of_day", "weather"]
...
class Frame(_message.Message):
    __slots__ = ["camera_labels", "context", "images", "laser_labels", "lasers", "map_features", "map_pose_offset", "no_label_zones", "pose", "projected_lidar_labels", "timestamp_micros"]
...
class LaserCalibration(_message.Message):
    __slots__ = ["beam_inclination_max", "beam_inclination_min", "beam_inclinations", "extrinsic", "name"]
...
class RangeImage(_message.Message):
    __slots__ = ["camera_projection_compressed", "range_image", "range_image_compressed", "range_image_flow_compressed", "range_image_pose_compressed", "segmentation_label_compressed"]
