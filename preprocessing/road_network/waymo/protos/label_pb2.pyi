from protos import keypoint_pb2 as _keypoint_pb2
...
class Label(_message.Message):
    __slots__ = ["association", "box", "camera_keypoints", "camera_synced_box", "detection_difficulty_level", "id", "laser_keypoints", "metadata", "most_visible_camera_name", "num_lidar_points_in_box", "num_top_lidar_points_in_box", "tracking_difficulty_level", "type"]
    ...
    class Box(_message.Message):
        __slots__ = ["center_x", "center_y", "center_z", "heading", "height", "length", "width"]
        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = []
    ...
    class Metadata(_message.Message):
        __slots__ = ["accel_x", "accel_y", "accel_z", "speed_x", "speed_y", "speed_z"]
