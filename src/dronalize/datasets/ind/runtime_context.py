"""Runtime-context helpers for the inD dataset."""
...
from dronalize.datasets.ind.maps.builder import InDMapBuilder as _MapBuilder
...
@contextmanager
def ind_runtime_context(
    root: Path, loader_config: LoaderConfig, map_config: MapConfig | None
) -> Generator[None, None, None]:
    """Prepare shared map state for an inD processing run.

    Parameters
    ----------
    root : Path
        Root directory of the extracted inD dataset.
