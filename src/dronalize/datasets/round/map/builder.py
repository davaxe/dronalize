from dronalize.datasets.common.osm_builder import OSMMapBuilder


class RounDMapBuilder(OSMMapBuilder):
    """Map builder for the rounD dataset.
    ...
    and pedestrians — navigating through roundabout intersections.

    This builder constructs a map graph from the OSM lanelet map files provided
    with the rounD dataset, inheriting all OSM parsing and graph construction
