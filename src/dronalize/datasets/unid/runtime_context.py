"""Runtime-context helpers for the uniD dataset."""
...
from dronalize.datasets.unid.maps.builder import UniDMapBuilder as _MapBuilder
...
@contextmanager
def unid_runtime_context(
    root: Path, loader_config: LoaderConfig, map_config: MapConfig | None
) -> Generator[None, None, None]:
    """Prepare shared map state for a uniD processing run.

    Parameters
    ----------
    root : Path
        Root directory of the extracted uniD dataset.
