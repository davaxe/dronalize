...
if TYPE_CHECKING:
    ...
    from dronalize.plot.theme import DARK_THEME, LIGHT_THEME, PlotTheme, ThemeName

AspectMode = Literal["auto", "equal"]
"""Aspect-ratio modes accepted by [`plot_scene`][dronalize.plot.plot_scene]."""

__all__ = ["AspectMode", "DARK_THEME", "LIGHT_THEME", "PlotTheme", "ThemeName", "plot_scene"]
...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ThemeName": ("dronalize.plot.theme", "ThemeName"),
    "LIGHT_THEME": ("dronalize.plot.theme", "LIGHT_THEME"),
    "DARK_THEME": ("dronalize.plot.theme", "DARK_THEME"),
}
