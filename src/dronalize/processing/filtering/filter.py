...
from dronalize.processing.filtering.agent import AgentCheckSpec
from dronalize.processing.filtering.base import AgentCheckRule, CleanupRule, Rule, SceneCheckRule
from dronalize.processing.filtering.cleanup import CleanupSpec, PruneByRule
from dronalize.processing.filtering.scene import SceneCheckSpec
...
class Filter:
    ...
    @classmethod
    def define_cleanup(cls, *rules: CleanupRule | AgentCheckSpec) -> Filter:
...
class FilterSpec(BaseModel):
    ...
    cleanup: CleanupSpecs
    scene: SceneCheckSpecs
    agent: AgentCheckSpecs
...
def _as_cleanup_rule(rule: CleanupRule | AgentCheckSpec) -> CleanupRule:
