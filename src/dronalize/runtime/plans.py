"""Transitional runtime planning models."""
...
from dronalize.config.sections import MapConfig, effective_scene_window
...
class RunPlan:
    ...
    def parallel(self) -> bool:
        ...
        return self.runtime.jobs == "auto" or self.runtime.jobs > 1

    @property
    def workers(self) -> int | None:
        """Return the number of workers requested by the runtime plan."""
        if self.runtime.jobs == "auto":
            return None
