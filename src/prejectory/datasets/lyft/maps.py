...
from prejectory.datasets.lyft.protos import road_network_pb2 as proto
from prejectory.processing.maps import FeatureMapBuilder, PathFeature

if TYPE_CHECKING:
    from collections.abc import Iterable, Sequence

    from prejectory.processing.maps import Point
