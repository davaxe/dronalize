...
from prejectory.core.categories import AgentCategory, AgentCategoryInput, AgentCategoryLike
...
if TYPE_CHECKING:
    from prejectory.processing.screening.base import ScreeningContext
