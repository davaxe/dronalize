...
from prejectory.runtime.progress import execute_with_rich_progress
from prejectory.runtime.resolve import build_execution_plan
from prejectory.runtime.types import ExecutionResult

if TYPE_CHECKING:
    from prejectory.runtime.types import ExecutionPlan, ExecutionRequest
...
def resolve_request(request: ExecutionRequest) -> ExecutionPlan:
    ...
    ExecutionPlan
        ...
        [`execute_plan`][prejectory.runtime.execute_plan].
